...
(function() {
  'use strict';
  var CND, Intertype, L, alert, badge, debug, help, info, intertype, jr, rpr, urge, validate_npm_name, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('frei_npmname', {
    tests: {
      "x is a text": function(x) {
        return this.isa.text(x);
      },
      "x isa _frei_npmname": function(x) {
        return this.isa._frei_npmname(x);
      }
    }
  });

  //-----------------------------------------------------------------------------------------------------------
  this.declare('_frei_npmname', function(x) {
    return (validate_npm_name(x)).validForNewPackages;
  });
