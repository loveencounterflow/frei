...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.walk_all_possible_names = function*(count) {
  ...
  this.f = function() {
    return new Promise((resolve) => {
      var all_npmnames, chr_count, pipeline, source;
      all_npmnames = new Set(this.all_npmnames);
      chr_count = 2;
      source = this.walk_all_possible_names(chr_count);
      pipeline = [];
      ...
      pipeline.push(SP.$filter(function(name) {
        return !/[._-]/.test(name);
      }));
      pipeline.push(SP.$filter(function(name) {
      ...
      // pipeline.push $watch
      pipeline.push($drain(function(names) {
